...
const ROLE_GRANTS: Record<Role, readonly (typeof PERMISSIONS)[number]["key"][]> = {
  ...
  ADMIN: [
    ...
    "payments.webhooks.manage", "payments.logs.read", "commercial.withdrawals.read",
    "commercial.withdrawals.approve", "affiliate.applications.read",
  ...
  FINANCE: [
    ...
    "commercial.withdrawals.read", "commercial.withdrawals.approve",
  ],
  ...
  COMPLIANCE: [
    ...
    "payments.webhooks.read", "payments.logs.read", "commercial.withdrawals.read",
    "affiliate.applications.read", "affiliate.commissions.read", "manager.read",
  ],
  AUDIT: [
