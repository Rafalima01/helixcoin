...
export class InMemoryCommercialWithdrawRepository implements ICommercialWithdrawRepository {
  ...
  /** Join fields are placeholders — this test double has no User store of its own; not exercised by any test that asserts on them (same convention as payments' InMemoryWithdrawRepository). */
